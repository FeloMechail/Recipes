...
const RecipeDetails = ({ recipe }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <p className="text-md text-gray-600 mt-2">Published on: {new Date(recipe.date).toLocaleDateString()}</p>
      <div className="mt-4">
        <h2 className="text-xl font-semibold">Description</h2>
        {recipe.desc ? <p className="text-gray-700">{recipe.desc}</p> : <p className="italic text-gray-700">No description provided.</p>}
      </div>
      <div className="mt-4">
